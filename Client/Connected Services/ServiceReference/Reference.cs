...
namespace Client.ServiceReference {
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="ServiceReference.ICeadChatService", CallbackContract=typeof(Client.ServiceReference.ICeadChatServiceCallback))]
    ...
    public interface ICeadChatServiceCallback {
        ...
        void CreateChatCallback(Client.ServiceReference.GroupWCF group, int creatorId);
        ...
        void CreateMessageCallback(Client.ServiceReference.MessageWCF message, long hash);
        ...
        void DeleteMessageCallback(Client.ServiceReference.MessageWCF message);
        ...
        void NewLastMessageCallback(Client.ServiceReference.MessageWCF message);
        ...
        void AddFriendToGroupCallback(Client.ServiceReference.UserBaseWCF user, Client.ServiceReference.GroupWCF group);
        ...
        void RemoveGroupCallback(Client.ServiceReference.GroupWCF group);
        ...
        void ReadedMessagesCallback(Client.ServiceReference.GroupWCF group, Client.ServiceReference.UserBaseWCF sender);
        ...
        void ChangeTextInMessageCallback(Client.ServiceReference.MessageWCF message);
        ...
        void RemoveOrExitUserFromGroupCallback(int groupId, Client.ServiceReference.UserBaseWCF user);
        ...
        void AddUserToBlackListCallback(Client.ServiceReference.UserBaseWCF user);
        ...
        void RemoveUserFromBlackListCallback(Client.ServiceReference.UserBaseWCF user);
        
        [System.ServiceModel.OperationContractAttribute(IsOneWay=true, Action="http://tempuri.org/ICeadChatService/AddContactCallback")]
        void AddContactCallback(Client.ServiceReference.UserBaseWCF user);
        ...
        void RemoveContactCallback(Client.ServiceReference.UserBaseWCF user);
    }
